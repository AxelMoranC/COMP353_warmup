...
INSERT INTO Persons 
    (FirstName, LastName, DateOfBirth, SocialSecurity, MedicareCard, PhoneNumber, Citizenship, Email, Address, City, Province, PostalCode, ResidenceID, StartedDateAtAddress) 
VALUES
    ('John', 'Doe', '1990-05-15', '123456789', 'M987654321', '514-206-1720', 'Canadian', 'john.doe@gmail.com', '123 West', 'Montreal', 'Quebec', 'H4S 3L4', 1, '2015-01-01'),
    ('Marquez', 'Valdes', '1985-08-20', '124567890', 'M876543210', '514-262-3333', 'Canadian', 'marquez.valdes@gmail.com', '456 Maple', 'Laval', 'Quebec', 'G12 J37', 2, '2015-01-01'),
    ('Robert', 'Camacho', '2000-03-01', '402417090', 'M888888888', '514-292-1611', 'Canadian', 'robert.camacho@mail.concordia.ca', '1210 George', 'LaSalle', 'Quebec', 'H7N 1LN', 3, '2015-01-01'),
    ('Axel', 'James', '2001-04-28', '402567891', 'M888888880', '514-268-3456', 'Canadian', 'axel.james@yahoo.com', '457 West', 'Montreal', 'Quebec', 'G12 J38', 4, '2015-01-01'),
    ('Gigi', 'Hudda', '1958-07-15', '412876987', 'M888888800', '438-986-1211', 'Canadian', 'gigi.hudda@gmail.com', '458 Coconut', 'Montreal', 'Quebec', 'H9S 335', 'A1B 2C3', 5, '2015-01-01'),
    ('Blind', 'Spot', '1963-06-20', '433456781', 'M123456780', '438-700-1513', 'French', 'blind.spot@gmail.com', '007 Lemieux', 'Montreal', 'Quebec', 'J89 L7N', 6, '2015-01-01'),
    ('Jonathan', 'Jababo', '1968-08-24', '245678910', 'M669876541', '418-089-3690', 'Canadian', 'jonathan.jababo@gmail.com', '661 Croissant', 'Sherbrooke', 'Quebec', 'H12 J37', 7, '2015-01-01'),
    ('Joseph', 'Joestar', '1989-12-25', '876543219', 'M098762315', '514-262-3334', 'Canadian', 'joseph.joestar@hotmail.com', '420 Wolly', 'London', 'Ontario', 'B2C 3D4', 8, '2015-01-01'),
    ('Juba', 'Smith', '1974-05-08', '111111111', 'M881234567', '450-671-1911', 'American', 'SmithAlways@outlook.com', '785 Williams', 'Buffalo', 'New York', 'GI8 ZNI', 9, '2015-01-01'),
    ('Shanvin', 'Luo', '1999-01-01', '678456782', 'M098734561', '514-262-3335', 'American', 'CuO_1245@gmail.com', '978 Loyola', 'Seattle', 'Washington', 'H4S 3L5', 10, '2015-01-01'),
    ('Roburnto', 'David', '1956-11-11', '314562345', 'M876543211', '514-262-3338', 'Peruvian', 'rob123@gmail.com', '745 Campusia', 'Lima', 'Lima', '78Z N89', 11, '2015-01-01'),
    ('Timothy', 'Wang', '1999-01-21', '688954612', 'M1', '514-333-4444', 'Canadian', 'Timothy.Wang@gmail.com', '123 West', 'Montreal', 'Quebec', 'H4S 3L4', 12, '2015-01-01'),
    ('Francois', 'Lacelle', '1978-10-10', '229031456', 'M2', '438-383-6785', 'Canadian', 'Francois_Lacelle@gmail.com', '1210 George', 'LaSalle', 'Quebec', 'H7N 1LN', 13, '2015-01-01'),
    ('Anthony', 'Dumont', '1960-12-12', '196012121', 'M3', '450-665-1819', 'American', 'Anthony.Dumont@mail.concordia.com', '457 West', 'Montreal', 'Quebec', 'G12 J38', 14, '2015-01-01'),
    ('Anna', 'Labella', '1984-05-12', '198405128', 'M4', '438-448-5957', 'Peruvian', 'Anna_Labella@hotmail.com', '420 Wolly', 'London', 'Ontario', 'B2C 3D4', 15, '2015-01-01'),
    ('Eva', 'Mendez', '1982-09-30', '332211445', 'M5', '514-345-6789', 'Canadian', 'eva.mendez@gmail.com', '745 Campusia', 'Lima', 'Lima', '78Z N89', 16, '2015-01-01'),
    ('Carlos', 'Rodriguez', '1995-06-12', '443322116', 'M112233445', '450-789-0123', 'Canadian', 'carlos.rodriguez@gmail.com', '567 Oak', 'Laval', 'Quebec', 'G45 J89', 17, '2015-01-01'),
    ('Linda', 'Turner', '1970-03-25', '554433226', 'M224466880', '716-123-4567', 'American', 'linda.turner@gmail.com', '890 Pine', 'LaSalle', 'Quebec', 'H7N 2LN', 18, '2015-01-01'),
    ('Kevin', 'Baker', '1988-11-18', '665544337', 'M559911778', '514-789-0123', 'Canadian', 'kevin.baker@gmail.com', '234 Birch', 'Montreal', 'Quebec', 'G12 K78', 19, '2015-01-01'),
    ('Sophie', 'Williams', '2000-05-02', '776655448', 'M6', '438-234-5678', 'Canadian', 'sophie.williams@gmail.com', '123 West', 'Montreal', 'Quebec', 'H4S 3L4', 20, '2015-01-01'),
    ('Jack', 'Perry', '1984-07-18', '887766559', 'M7', '716-890-1234', 'American', 'jack.perry@gmail.com', '785 Williams', 'Buffalo', 'New York', 'GI8 ZNI', 21, '2015-01-01'),
    ('Diana', 'Lopez', '1992-02-11', '998877660', 'M660022116', '819-123-4567', 'Canadian', 'diana.lopez@gmail.com', '543 Tulip', 'Lima', 'Lima', '78Z N87', 22, '2015-01-01'),
    ('Alan', 'Scott', '1978-09-05', '009988771', 'M8', '519-234-5678', 'Canadian', 'alan.scott@gmail.com', '543 Tulip', 'Lima', 'Lima', '78Z N87', 23, '2015-01-01'),
    ('Olivia', 'Clark', '1985-12-20', '110022334', 'M334455660', '716-345-6789', 'Canadian', 'olivia.clark@gmail.com', '321 Daisy', 'Montreal', 'Quebec', 'HHI 3JK', 24, '2015-01-01'),
    ('Daniel', 'Evans', '1996-04-06', '221133446', 'M9', '206-567-8901', 'Canadian', 'daniel.evans@gmail.com', '978 Loyola', 'Seattle', 'Washington', 'H4S 3L5', 25, '2015-01-01');
...
INSERT INTO Schedule (MedicareCard, FacilityID, Schedule_Date, StartTime, EndTime, is_no_assignment) VALUES
  ('M654321987', 11, '2024-04-01', '08:00:00', '12:00:00', 0),
  ('M123456789', 12, '2024-04-02', '09:00:00', '13:00:00', 0),
  ('M987654321', 13, '2024-04-03', '10:00:00', '14:00:00', 0),
  ('M321654987', 13, '2024-04-04', '11:00:00', '15:00:00', 0),
  ('M654987321', 11, '2024-04-05', '12:00:00', '16:00:00', 0);
...
INSERT INTO SecondaryResidence (PersonID, ResidenceID, ResidenceType, StartDateAtAddress) VALUES
  (16, 101, 'Secondary', '2010-05-20'),
  (17, 102, 'Secondary', '2015-08-12'),
  (19, 103, 'Secondary', '2017-11-15');
